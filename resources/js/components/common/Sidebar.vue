...
const links = ref([
    ...
    { icon: 'mdi-clock-outline', text: 'Sessions', active: computed(() => route.path === '/training' || route.path === '/create-training'), route: '/training' },    { icon: 'mdi-account-multiple', text: 'Clients', active: computed(() => route.path === '/'), route: '/' },
